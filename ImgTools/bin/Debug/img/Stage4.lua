...
function GameOption(pGameData)
	...
	pGameData:Dummy( 900, -1, 1, "kenttttttttt", 1 )	
	return 0
end

function MainMission(pGameData)
	pGameData:MainMissionType( 1, 50 )
end
...
StageName		= "Cavando tunel"

MissionText_1		= "Condición de la misión"
MissionText_2		= "Conseguir 50 puntos"
...
Story			= "Adium realizo una petición para cavar un túnel hacia la entrada a las reliquias. Allí hay muchos Raons. Destrúyelos y cava el túnel hacia la entrada."
